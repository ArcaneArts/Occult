...
class RequestAuthenticator {
  ...
  Future<AuthResponse> _isAuthenticatedRequest(Request request) async {
    ...
    CMUser? u = await $crud.get<CMUser>(uid);
    ...
    CMUserSettings? settings = await u.getUnique<CMUserSettings>();
...
extension XRequest on Request {
  ...
  Future<CMUserCapabilities> get capabilities => getCached(
      id: "capabilities.$uid",
      getter: () =>
          $crud.model<CMUser>(uid).getUnique<CMUserCapabilities>().bang,
