...
/// Configuration is stored in ~/.occult/config.yaml by default.
@cliSubcommand
...
''';
  ...
  Future<void> get(
    ...
    if (!configFile.existsSync()) {
      error("Configuration not found. Run 'occult config init' first.");
      return;
    }
  ...
  Future<void> path() async {
    ...
    if (!exists) {
      info("Run 'occult config init' to create configuration");
    }
  }
}
