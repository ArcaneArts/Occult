...
final List<DartedCommand> commandsTree = [
  ...
  DartedCommand(
    name: 'gui',
    helperDescription: 'Launch the Occult GUI wizard',
...
void _printDeployHelp() {
  ...
  print('');
  print('Run "occult deploy <subcommand>" for more information.');
}
